        ...
        <div className="sheet-detail-item">
          ...
          <div className="sheet-detail-content">
            <table className="sheet-detail-table">
              <thead>
                <tr>
                  <th><div className="sheet-table-header"> </div>No</th>
                  <th><div className="sheet-table-header"> </div>Role</th>
                  <th><div className="sheet-table-header"> </div>Account</th>
                  <th><div className="sheet-table-header"> </div>Full Name</th>
                  <th><div className="sheet-table-header"> </div>Email</th>
                  <th><div className="sheet-table-header"> </div>Star Date</th>
                </tr>
              </thead>
              <tbody>
                <tr>
