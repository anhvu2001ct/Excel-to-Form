...
export default function Modal({ file, close }: Props) {
  ...
  const handleChange = (e: any) => {
    ...
    console.log("handleChange ~ name, values", name, values);
    setWorkbookImport({ ...workbookImport, name: values });
    console.log(workbookImport);
  };
    ...
    <Fragment>
      <form className={`modal `}>
        <div className="modal-container">
          ...
          <ModalHeader onChange={handleChange} />
